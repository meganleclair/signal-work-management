...
type FaIconProps = Omit<SVGProps<SVGSVGElement>, "viewBox"> & {
...
/** Sun — filled circle with 8 rays (Heroicons solid, 24×24 viewBox) */
export const faSun = {
  width: 24,
  height: 24,
...
/** Sparkles — three-star sparkle (Heroicons solid, 24×24 viewBox) */
...
/** Moon — crescent (Heroicons solid, 24×24 viewBox) */
export const faMoon = {
  width: 24,
  height: 24,
...
/** Ellipsis vertical — three vertical dots (FA solid) */
export const faEllipsisVertical = {
  width: 128,
  height: 512,
  path: "M64 360a56 56 0 1 0 0 112 56 56 0 1 0 0-112zm0-160a56 56 0 1 0 0 112 56 56 0 1 0 0-112zm0-160a56 56 0 1 0 0 112 56 56 0 1 0 0-112z",
} satisfies FaIconDefinition;
